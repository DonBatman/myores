...
core.register_node("myores:mystery_block",{
	...
	on_destruct = function(pos)
		...
		elseif rand == 31 then
			core.spawn_item(pos,"beds:fancy_bed_bottom 1")
		elseif rand == 32 then
			core.spawn_item(pos,"binoculars:binoculars 1")
		elseif rand == 33 then
			core.spawn_item(pos,"bucket:bucket_lava 1")
		elseif rand == 34 then
			core.spawn_item(pos,"bucket:bucket_water 1")
		elseif rand == 35 then
